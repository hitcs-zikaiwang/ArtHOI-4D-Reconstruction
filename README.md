...
ArtHOI targets 4D reconstruction of hand-articulated-object interactions under monocular video input, without requiring object pre-scans or multi-view capture.

## TODOs

We will update this repository soon. Planned release order:

1. Code and environment setup.
2. Data processing scripts and docs.
3. Dataset details and download.

## Updates

- **[2026-01]** Paper accepted by CVPR 2026.
- **[2026-03]** Project page released.
- **[TBD]** Code and dataset release.
...
- Zikai Wang: cs-zikaiwang@outlook.com
