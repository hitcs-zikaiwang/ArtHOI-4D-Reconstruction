...
def main():
    ...
    parser.add_argument("--interval", type=int, default=1, help="Interval between images in seconds, defaults to 1")
    parser.add_argument("-r", "--round", type=int, default=1, help="Number of merge rounds, defaults to 1")
...
"""
python vlmho_gen.py \
    -i ds/rsrd/rsrd_nerfgun/build \
    -o mllm_output/rsrd_nerfgun/k3k1r50 \
    -k 3 -r 50 --interval 1
"""
